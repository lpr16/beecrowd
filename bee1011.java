...
Make a program that calculates and shows the volume of a sphere being provided the value 
of its radius (R) . The formula to calculate the volume is: (4/3) * pi * R3. 
...
and after the equal signal. The value must be presented with 3 digits after the decimal point.
*******************************************/
